                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    >
                      ...
                      {categories.filter(c => c.parent_category === 'kids').length > 0 && (
                        <optgroup label="Kids">
                          {categories
                            .filter(c => c.parent_category === 'kids')
                            .map(category => (
                              <option key={category.id} value={category.id}>
                                {category.name}
                              </option>
                      ...
                      {/* Fallback: show kids category even if parent_category is null */}
                      {categories.filter(c => c.slug === 'kids' && c.parent_category !== 'kids').length > 0 && (
                        <optgroup label="Kids">
                          {categories
                            .filter(c => c.slug === 'kids' && c.parent_category !== 'kids')
                            .map(category => (
                              <option key={category.id} value={category.id}>
                                {category.name}
                              </option>
